...
export type SetReposType = (repos: RepoObject[]) => void;
export type SetLanguagesType = (languages: string[]) => void;

export type HandleChangeType = (event: SelectChangeEvent<string>) => void;
